...
#include "constrained_ik/constraints/avoid_collision.h"
#include <ros/ros.h>
...
AvoidCollision::AvoidCollision()
{
    ...
    fcl::Vec3f p1 = result.nearest_points[0];
    p1.data;
    ROS_INFO("arg");
}

Eigen::VectorXd AvoidCollision::calcError()
{
...
Eigen::MatrixXd AvoidCollision::calcJacobian()
{
  MatrixXd tmpJ;
